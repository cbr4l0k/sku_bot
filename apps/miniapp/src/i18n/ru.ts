...
export const ru = {
  ...
  "form.city": "Город",
  "form.cityHint": "Событие увидят только те, кто выбрал этот город",
  "form.groups": "Только для групп",
  "form.groupsHint": "Событие увидят только участники выбранных Telegram-групп. Пусто — видно всем",
  "form.homeChat": "Чат события",
  "form.homeChatHint": "Всем, кто занял место, придёт приглашение. Новичков, которые не отметились, уберём после события",
  "form.homeChatNone": "Без чата",
  ...
  "admin.groupMovedTo": "группа переехала на {id} — перенос выполнен автоматически",
  ...
  "city.chooseTitle": "Твой город",
  "city.chooseHint": "Будем показывать пробежки этого филиала. Поменять можно в профиле в любой момент.",
  "city.elsewhere": "Другой город",
  "role.admin": "Админ филиала",
  "role.organizer": "Организатор",
  "role.none": "Без роли",
  "role.assign": "Роль в филиале",
  "admin.tabChats": "Чаты",
  "admin.chatsUnassigned": "Ждут филиала",
  "admin.chatsUnassignedHint": "Бот состоит в этих чатах, но не знает, чьи они. Выбери филиал — и чат станет доступен его событиям.",
  "admin.chatsEmpty": "Пока ни одного чата. Добавь бота администратором в группу — она появится здесь сама.",
  "admin.chatUnfile": "Убрать из филиала",
  "admin.chatsReadOnly": "Распределять чаты по филиалам может только общий администратор.",
  "toast.chatFiled": "Чат сохранён",
  "toast.roleSaved": "Роль сохранена",
  "err.chat_not_found": "Чат не найден",
} as const;
